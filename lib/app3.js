...
function drawScene() {
		...
		var cardir2=carAngle*Math.PI/180;
	
		//WORLD MATRIX
		
		//translation of (carX,carY,carZ)
		var C = [1,0,0,carX,
				 0,1,0,carY,
				 0,0,1,carZ,
				 0,0,0,1];
		//rotation of carAngle around the y axis
		var D = [Math.cos(cardir2),	0,	Math.sin(cardir2),	0,
				 0,					1,	0,					0,
				 -Math.sin(cardir2),0,	Math.cos(cardir2),	0,
				 0,					0,	0,					1];
		...
		var Vz = utils.normalizeVector3([cx-carX, cy-carY, cz-carZ]);
